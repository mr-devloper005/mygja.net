...
export function EditableContactLeadForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="editable-dark-panel mt-6 rounded-[2rem] p-6 md:p-8">
      ...
      <label className="mt-4 grid gap-2 text-sm font-semibold text-[var(--slot4-muted-text)]">
        ...
        <textarea
          ...
          className="editable-dark-input rounded-[1.4rem] px-4 py-3 text-base font-medium outline-none transition focus:border-[var(--slot4-accent)]"
        />
      </label>
      ...
      <button
        ...
        className="mt-6 inline-flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-[var(--editable-cta-bg)] px-6 text-sm font-semibold uppercase tracking-[0.18em] text-[var(--editable-cta-text)] shadow-[0_8px_24px_rgba(255,194,28,0.18)] transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-70"
      >
  ...
  return (
    <label className="grid gap-2 text-sm font-semibold text-[var(--slot4-muted-text)]">
      ...
      <input
        ...
        className="editable-dark-input h-12 rounded-[1.4rem] px-4 text-base font-medium outline-none transition focus:border-[var(--slot4-accent)]"
      />
    </label>
  )
}
